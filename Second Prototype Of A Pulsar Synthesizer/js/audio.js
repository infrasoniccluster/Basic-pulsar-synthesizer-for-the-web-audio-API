...
function createPWMOsc(freq, dutyCycle) {
 ...
 output = audioContext.createGain();
	...
	output.gain.value = 0.0;  // purely for debugging.
...
/*
	...
	*/
    ...
    function loadSound(url) {
       ...
       request.open('GET', "data/gauss -2db with silence.wav", true);
...
//vol.connect(audioContext.destination); // connect the source to the context's destination (the speakers)
